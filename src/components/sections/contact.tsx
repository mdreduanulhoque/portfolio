...
export function ContactSection() {
    const { data: links, loading } = useFirestoreDoc<SocialLinks>("social_links", "main");
        ...
        <section id="contact" className="py-24 relative overflow-hidden bg-muted/10">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                    <a href={`mailto:${l.email}`} className="group p-6 rounded-2xl border border-border/50 bg-background/50 backdrop-blur-sm hover:border-primary/50 hover:shadow-lg transition-all flex items-center gap-4 hover:-translate-y-1">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground mt-1">{l.email}</p>
                        </div>
                    </a>

                    <a href={l.linkedin} target="_blank" rel="noreferrer" className="group p-6 rounded-2xl border border-border/50 bg-background/50 backdrop-blur-sm hover:border-[#0A66C2]/50 hover:shadow-lg transition-all flex items-center gap-4 hover:-translate-y-1">
                    ...
                    <a href={l.github} target="_blank" rel="noreferrer" className="group p-6 rounded-2xl border border-border/50 bg-background/50 backdrop-blur-sm hover:border-foreground/50 hover:shadow-lg transition-all flex items-center gap-4 hover:-translate-y-1">
                    ...
                    <a href={l.facebook} target="_blank" rel="noreferrer" className="group p-6 rounded-2xl border border-border/50 bg-background/50 backdrop-blur-sm hover:border-[#1877F2]/50 hover:shadow-lg transition-all flex items-center gap-4 hover:-translate-y-1">
